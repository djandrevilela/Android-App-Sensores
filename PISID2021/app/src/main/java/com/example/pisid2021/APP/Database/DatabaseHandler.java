...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void insertMedicao(String hora, double leitura, boolean outlier) {
        ...
        //values.put(DatabaseConfig.Medicao.COLUMN_NAME_OUTLIER, outlier);
        getWritableDatabase().insert(DatabaseConfig.Medicao.TABLE_NAME,null, values);
    }

    public void insertAlerta(String hora, int tipoAlerta, String mensagem, int idUtilizador, int idCultura, int idMedicao) {
        ContentValues values = new ContentValues();
        ...
        values.put(DatabaseConfig.Alerta.COLUMN_NAME_ID_MEDICAO, idMedicao);

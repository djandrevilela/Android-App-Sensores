...
public class AlertasActivity extends AppCompatActivity {
        ...
        try{
            if(alertas!=null){
                for (int i=0;i< alertas.length();i++){
                    ...
                    int tipoAlerta = c.getInt("Tipo_Alerta");
                    String mensagem = c.getString("Mensagem");
                    int idUtilizador;
                    try {
                        idUtilizador = c.getInt("ID_Utilizador");
                    } catch (Exception e) {
                        idUtilizador = 0;
                    }
                    int idCultura;
                    try {
                        idCultura = c.getInt("ID_Cultura");
                    } catch (Exception e) {
                        idCultura = 0;
                    }
                    int id_medicao = c.getInt("ID_Medicao");
                    db.insertAlerta(hora, tipoAlerta, mensagem, idUtilizador, idCultura, id_medicao);
                }
            }
    ...
    private void listAlertas() {
        ...
        List<String> alertaFields = Arrays.asList(new String[]{"ID_Zona", "Sensor", "Hora", "Leitura", "Tipo_Alerta", "Nome_Cultura", "Mensagem", "ID_Utilizador", "ID_Cultura", "Hora_Medicao"});
        ...
        while (cursorAlertas.moveToNext()){
            ...
            TextView idzona = new TextView(this);
            String valorZona = Integer.toString(cursorAlertas.getInt(cursorAlertas.getColumnIndex("ID_Zona")));
            if (valorZona == null || valorZona.equals("null")) valorZona = "";
            idzona.setText(valorZona);
            idzona.setPadding(dpAsPixels(16),dpAsPixels(5),dpAsPixels(5),0);
            ...
            String valorTipoAlerta = Integer.toString(cursorAlertas.getInt(cursorAlertas.getColumnIndex("Tipo_Alerta")));
            ...
            TextView nomeCultura = new TextView(this);
            String valorCultura = cursorAlertas.getString(cursorAlertas.getColumnIndex("Nome_Cultura"));
            if (valorCultura == null || valorCultura.equals("null")) valorCultura = "";
            nomeCultura.setText(valorCultura);
            nomeCultura.setPadding(dpAsPixels(16),dpAsPixels(5),dpAsPixels(5),0);
            ...
            String valorIDUtilizador = Integer.toString(cursorAlertas.getInt(cursorAlertas.getColumnIndex("ID_Utilizador")));
            ...
            String valorIDCultura = Integer.toString(cursorAlertas.getInt(cursorAlertas.getColumnIndex("ID_Cultura")));
            idCultura.setText(valorIDCultura);
            idCultura.setPadding(dpAsPixels(16),dpAsPixels(5),dpAsPixels(5),0);

            TextView horaMedicao = new TextView(this);
            String valorHoraMedicao = cursorAlertas.getString(cursorAlertas.getColumnIndex("Hora_Medicao"));
            if (valorHoraMedicao == null || valorHoraMedicao.equals("null")) valorHoraMedicao = "";
            horaMedicao.setText(valorHoraMedicao);
            horaMedicao.setPadding(dpAsPixels(16),dpAsPixels(5),dpAsPixels(5),0);
